...
AgeOfOldSingles := 60         ; When removing old "single-occurence items," only remove strings older than this many days.
...
radioColor := (GetColorDarkness(formColor) < 50)? radioColorDark : radioColorLight
